...
var CidadeService = /** @class */ (function () {
    function CidadeService(cidadeRepository, estadoRepository) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        estado = _a.sent();
                        if (!estado) {
                            throw new app_error_1.AppError("O estado com ID ".concat(data.estado_id, " n\u00E3o foi encontrado."), 400);
                        }
                    ...
                    case 2:
                        ...
                        if (cidadeExistenteComNome) {
                            throw new app_error_1.AppError("A cidade \"".concat(data.cidade_nome, "\" j\u00E1 existe no estado ").concat(estado.estado_sigla, " (ID: ").concat(data.estado_id, ")."), 409);
                        }
                    ...
                    case 4:
                        ...
                        throw new app_error_1.AppError("Erro ao criar a cidade.", 500, false);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        deleted = _a.sent();
                        if (!deleted) {
                            throw new app_error_1.AppError("Cidade com ID ".concat(id, " n\u00E3o encontrada para exclus\u00E3o."), 404);
                        }
                        return [3 /*break*/, 3];
                    case 2:
                        error_3 = _a.sent();
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (outraCidadeComNome && outraCidadeComNome.cidade_id !== id) {
                            throw new app_error_1.AppError("O nome de cidade \"".concat(dataToUpdate.cidade_nome, "\" j\u00E1 existe no estado ID ").concat(estadoId, " (pertence \u00E0 cidade ID ").concat(outraCidadeComNome.cidade_id, ")."), 409);
                        }
                        _a.label = 3;
                    case 3:
                        // ================================================================
                        ...
                        delete dataToUpdate.estado_id;
                        return [4 /*yield*/, this.cidadeRepository.update(id, dataToUpdate)];
                    case 4:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        estado = _a.sent();
                        if (!estado) {
                            throw new app_error_1.AppError("Estado com ID ".concat(estadoId, " n\u00E3o encontrado."), 404);
                        }
