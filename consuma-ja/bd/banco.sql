...
-- Ajusta as colunas de fornecedor para permitir valores nulos quando um Admin cria registros globais.
ALTER TABLE `ConsumaJaDB`.`CATEGORIA_PRODUTO`
    MODIFY COLUMN `fornecedor_pessoa_id` INT UNSIGNED NULL DEFAULT NULL;

ALTER TABLE `ConsumaJaDB`.`TIPO_PRODUTO`
    MODIFY COLUMN `fornecedor_pessoa_id` INT UNSIGNED NULL DEFAULT NULL;

ALTER TABLE NOTIFICACAO
  MODIFY COLUMN notificacao_tipo ENUM(
    'VENDA_NOVA',
    'VENDA_ATUALIZADA',
    'VENDA_CONCLUIDA',
