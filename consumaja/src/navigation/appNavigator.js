...
const Sidebar = ({ navigation, isVisible, toggleMenu }) => {
  ...
  return (
    <Animated.View style={{
      ...
      <TouchableOpacity onPress={() => { navigation.navigate('Ofertas'); toggleMenu(); }}>
        <Text style={{ fontSize: 18, color: 'white', marginBottom: 15 }}>Ofertas</Text>
      </TouchableOpacity>
      <TouchableOpacity onPress={() => { navigation.navigate('Entregas'); toggleMenu(); }}>
        <Text style={{ fontSize: 18, color: 'white', marginBottom: 15 }}>Entregas</Text>
      </TouchableOpacity>
